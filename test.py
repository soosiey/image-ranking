...
if should_test:
    ...
    train_labels = np.load('embeddings/train_labels_{}_{}.npy'.format(model.name, start_epoch))
    test_labels = np.load('embeddings/test_labels_{}_{}.npy'.format(model.name, start_epoch))
